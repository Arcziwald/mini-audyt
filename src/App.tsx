...
const TRANSLATIONS = {
  PL: {
    ...
    gdprInfo: "Administratorem Twoich danych jest ArtWebCraft Artur Mochnia. Dane przetwarzamy w celu przesłania wyników audytu oraz prezentacji rozwiązań AI. Pełna polityka prywatności: https://artwebcraft.com/polityka",
  ...
  EN: {
    ...
    gdprInfo: "The administrator of your data is ArtWebCraft Artur Mochnia. We process data to send audit results and present AI solutions. Full privacy policy: https://artwebcraft.com/polityka",
